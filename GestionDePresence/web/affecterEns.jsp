...
<html>
        <head>
                ...
                <title>Affecter enseignant</title>
                <meta charset="UTF-8">
        ...
        <body>
                                        ...
                                        <ul class="navbar-nav mr-auto ">
                                                <li class="nav-item dropdown active">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item" href="#" >Affecter enseignant</a>
                                                        </div>
                                                </li>
                                                <li class="nav-item ">
                ...
                <br><br>
                <h3 class="text-center">Gestion des enseignants</h3> <br><br>




                <div class="formetudiant">
                        <form action="affecterEns" method="get">
                                <div class="container  ">
                                        <div class="row justify-content-start">
                                                <div>
                                                        Nom du Cours : &nbsp;<select id="saisirgroupe" name="saisircours"><option>--</option></select> 
                                                        &nbsp; 
                                                        <br><br>
                                                        Liste d'enseignant : <br><br>
                                                        <div class="tableau">
                                                                <input type="checkbox" onclick="toggle(this)" /> Tous selectionner &nbsp;&nbsp;&nbsp;
                                                                <input    class="btn btn-primary" style="display:inline-table" id="btn_ajouter" type="submit" value="ok">
                                                        </div>
                                                </div>
                                        </div>
                                </div>
