...
//window.onload = function choisir(){
//    var xhr = new XMLHttpRequest();
// //   var idR = document.getElementById("idResponsable").value;
//    xhr.open("GET","toutetu");
//    xhr.onload = function () {
//                if (xhr.status === 200) {
//                    var nav = document.getElementById("listEtudiant");
//                    var listee = xhr.responseXML.getElementsByTagName("etudiant");
//                    for (i = 0; i < listee.length; i++){
//                         var id = listee[i].getElementsByTagName("idE")[0].firstChild.nodeValue;
//                         var nom = listee[i].getElementsByTagName("NomE")[0].firstChild.nodeValue;
//                         var prenom = listee[i].getElementsByTagName("PrenomE")[0].firstChild.nodeValue;
//                         var tyEtu = listee[i].getElementsByTagName("TypeE")[0].firstChild.nodeValue;
//                         var tab = "<tr>\n\
//                                        <td>" + nom + "</td>\n\
//                                        <td>" + prenom + "</td>\n\
//                                        <td>" + tyEtu +"</td>\n\
...
//function affecter(){
// var xhr = new XMLHttpRequest();
//   var groupe = document.getElementById("saisirgroupe").value;
//  var idchoisi = []; //enregistrer toutes les valeurs de checkboxs choisis
//    var cbchoisi = document.getElementsByName("oui"); // acquérir les checkboxs choisis
//    for(var i=0;i<cbchoisi.length;i++){
//        if(cbchoisi[i].checked){
//            console.log(cbchoisi[i].value);
//            idchoisi.push(cbchoisi[i].value); //ajouter les valeurs de checkbox checked dans la liste
//        }
//    }
//   xhr.open("GET","affecter?idG="+groupe);
//}

//function choisiretudiant(){
//    var xhr = new XMLHttpRequest();
//    xhr.open("GET","etuchoisi");
//    var cbchoisi = document.getElementsByName("oui"); // acquérir les checkboxs choisis
//    xhr.onload = function () {
//             if (xhr.status === 200) {
//                   var nav = document.getElementById("listEtudiantChoisi");
//             }
//         
//     };
//
//}
//unvisible ou visible de div ajouter groupe;


//window.onload = function choisirformation(){
//    // Objet XMLHttpRequest.
//	var xhr = new XMLHttpRequest();
//        xhr.open("GET","choisirformation");
//        xhr.onload = function(){
//            if (xhr.status === 200){
//                var formation = xhr.responseXML.getElementsByTagName("formation");
//                var id = xhr.responseXML.getElementsByTagName("id");
//                // On construit les 'options' de notre liste déroulante.
//			var texte = "<option>--</option>";
//			for (var i=0; i<formation.length; i++)
//                texte += "<option values = " + id[i].firstChild.nodeValue + ">" + formation[i].firstChild.nodeValue + "</option>";
//             //   texte += "<option style=\"visibility: hidden: \">" + id[i].firstChild.nodeValue + "</option>";
//            //value = \"id[i].firstChild.nodeValue\"
//			// Elément html que l'on va mettre à jour.
//                          var sel_formation = document.getElementById("saisirformation");
//			  sel_formation.innerHTML = texte;
//                          
//            }
//        };
//        
...
document.addEventListener("DOMContentLoaded", () => {
        document.getElementById("saisirformation").addEventListener("change", l_cours);
        document.getElementById("saisirgroupe").addEventListener("change", l_groupe);
});
