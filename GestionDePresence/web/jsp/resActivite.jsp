<%-- 
    Document   : resActivite
    Created on : 26 mars 2020, 09:24:53
    Author     : shinu
--%>
...
<html>
        ...
        <body>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light  navbar-fixed-top">
                                ...
                                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                        <a  style="color:#d9d9d9;" id="user" class="navbar-brand" href="#" >
                                                <img src="resource/images/icons/user.png" width="30" height="30" class="d-inline-block align-top" alt="">
                ...
                <br/>
                <div class="container">
                        <div><h3 class="text-center">${msg_info}</h3></div>
                </div>
                <div class="container">
                        <div class="row justify-content-center">
                                <a href="vuerespon"><h5>Retour</h5></a>    
                        </div>
                </div>
