...
<html>
        ...
        <body>
                ...
                <br><br>
                <h3 class="text-center">Gestion de groupe</h3> <br><br>
                                ...
                                <div class="container  ">
                                        <div class="row justify-content-start">
                                                <div>
                                                        ...
                                                        <br><br>
                                                        Liste d'étudiant : <br><br>
                                                        <div class="tableau">
                                                                <input type="checkbox" onclick="toggle(this)" /> Tous sélectionner &nbsp;&nbsp;&nbsp;
                                                ...
                                                <div  class="col-6 col-sm-6 col-md-6 col-lg-6">
                                                        <div    id="ajouter" style="display:none" class="formajouter">
                                                                ...
                                                                <form action="ajoutergroupe" method="get">
                                                                        ...
                                                                        Nom du Groupe :  &nbsp; <input type="text"  class="form-control" id="ajoutergroupe" name="ajoutergroupe" size="10"> &nbsp; <input id="btn_ag"  class="btn btn-primary" type="submit" value="ajouter">
                                                                </form>
                                                        </div>
                                                </div>
                                        </div>
